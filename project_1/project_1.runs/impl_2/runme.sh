...
HD_PWD='/home/athanasi/Documents/GitHub/digital-circuit-lab/project_1/project_1.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log FourDigitLEDdriverTextTimer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FourDigitLEDdriverTextTimer.tcl -notrace
