...
synth_design -top FourDigitLEDdriverTextTimer -part xc7a100tcsg324-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef FourDigitLEDdriverTextTimer.dcp
create_report "synth_2_synth_report_utilization_0" "report_utilization -file FourDigitLEDdriverTextTimer_utilization_synth.rpt -pb FourDigitLEDdriverTextTimer_utilization_synth.pb"
