...
HD_PWD='C:/Users/athanasi/Documents/GitHub/digital-circuit-lab/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_transceiver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_transceiver.tcl -notrace
